...
class Registro():
    ...
    def guardar_datos(self,event):#BASE DE DATOS
            ...
            #se ingresan el nombre de usuario y contraseña validos en la base de datos 
            #si ya existe el usuario se le informa al usuario que el nombre de usuario ya existe
            #y se le pide que ingrese otro nombre de usuario
